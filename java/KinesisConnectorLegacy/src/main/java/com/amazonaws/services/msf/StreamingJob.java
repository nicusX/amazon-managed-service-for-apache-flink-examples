...
public class StreamingJob {
    ...
    // Legacy source
    private static FlinkKinesisConsumer<String> createKinesisConsumer(Properties inputProperties) {
        String streamName = inputProperties.getProperty("stream.name");
...
//                TypeInformation.of(String.class));
        ...
        // Legacy source
        FlinkKinesisConsumer<String> source = createKinesisConsumer(applicationProperties.get("InputStream0"));
